 ...
 */
public class MasterSelectorNode implements Watcher {

    private ZooKeeper zk;
    private String hostName;
    private String zNode;

    public MasterSelectorNode(String hostName, String zNode) throws Exception {
    ...
    public static void main(String[] args) throws Throwable {
        new MasterSelectorNode("localhost:2181", "/com/zhuyun/MasterElection/master");
