 ...
 */
public class MasterSelectorNode3 implements Watcher {

    private ZooKeeper zk;
    private String hostName;
    private String zNode;

    public MasterSelectorNode3(String hostName, String zNode) throws Exception {
    ...
    public static void main(String[] args) throws Throwable {
        new MasterSelectorNode3("localhost:2181", "/com/zhuyun/MasterElection/master");
